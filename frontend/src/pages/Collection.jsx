...
const Collection = () => {
  ...
  const sortProducts = productsCopy => {
    switch (sortType) {
      case 'low-high':
        return productsCopy.sort((a, b) => a.price - b.price); // ascending order

      case 'high-low':
        return productsCopy.sort((a, b) => b.price - a.price); // descending order

      default:
        return applyFilter(productsCopy);
    }
  };

  // To apply both Sorting and Filtering
